...
class App extends Component {
  ...
  getAllMovies = () => {
    axios
      .get(' https://mysterious-wildwood-26293.herokuapp.com/getallmovies')
      .then(result => {
  ...
  onSubmit = e => {
    ...
    const query = ` https://mysterious-wildwood-26293.herokuapp.com/getmovie?title=${
      this.state.title
    }`;
  ...
  removeMovie(title) {
    ...
    const query = ` https://mysterious-wildwood-26293.herokuapp.com/deletemovie?title=${title}`;
    axios
      .get(query)
      .then(result => {
        this.getAllMovies();
